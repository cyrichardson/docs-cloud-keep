...
exclude_patterns = ['_build', 'samples', 'api-reference/methods*',
                    'common-gs', 'release-notes/releases/*',
...
html_title = 'Rackspace Cloud Keep version 1.0 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Keep documentation'
...
htmlhelp_basename = 'docs-cloud-keepdoc'
...
latex_documents = [
  (master_doc, 'docs-barbican.tex',
   'Rackspace Cloud Keep API Guide',
   'Rackspace', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'reponame', 'Rackspace Cloud Keep API Documentation',
   'Rackspace', 'reponame', 'Learn about using the Cloud Keep',
   'Miscellaneous'),
]

...
You can use the examples in this section to create and manage
:ref:`secrets <secrets-concept>` by using |product name| API operations.
Example requests are provided in cURL, followed by the response.
...
.. note::
   ...
   variables to specify the API endpoint and authentication token for
   accessing the service. Be sure to
